...
class ImportAluminiumLocalMaterial implements ToModel, WithHeadingRow
{
    protected $rowIndex = 1;
    private $category_material = "Aluminium LOCAL (CONVENTIONAL)";
    ...
    public function model(array $row)
    {
        try {
            ...
            $data = [
                ...
                'profile' => config("common.profile.local"),
            ...
            Log::error('CLASS "ImportAluminiumLocalMaterial" FUNCTION "upload" ERROR: ' . $e->getMessage());
        }
    }
